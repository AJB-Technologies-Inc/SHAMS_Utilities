...
namespace SHAMS
{
    ...
    public:
         ...
         *
         * @param str - The string to initialize the buffer with
         * @param length - The length of the string to copy, excluding any null terminator
         *
         * @note The input string must not be null.
         */
        constexpr StaticString(const char *str, size_t length)
            : m_length(length)
        {
            std::copy(str, str + m_length, m_buffer.begin());
            m_buffer[m_length] = '\0';
        ...
        {
            std::ranges::transform(m_buffer, m_buffer.begin(), [](char c)
